...
WindAI Lab 是一個**風力發電領域的 AI 研究協作平台**，透過 42 個專業 AI 代理（Agent）的虛擬辦公室，讓研究人員、工程師與學生可以：

- 以自然語言指令驅動複雜的資料分析與 ML 建模流程
- 視覺化監控多個 AI 代理的協作狀態
- 快速建構風力發電相關的預測性維護、故障診斷、功率曲線分析等應用

**一句話描述**：像一間有 42 位 AI 研究員的虛擬研究室，各司其職處理風力發電的資料分析、機器學習與論文撰寫。
